 ...
 * @param {number} _system_index
 * @param {number} _entity_manager_ptr
 * @param {number} _delta_time
 * @returns {Promise<any>}
 */
export function execute_system_in_worker(_system_index, _entity_manager_ptr, _delta_time) {
    const ret = wasm.execute_system_in_worker(_system_index, _entity_manager_ptr, _delta_time);
    return ret;
}
...
export function start_game(canvas_element) {
    const ret = wasm.start_game(canvas_element);
    if (ret[1]) {
...
function __wbg_adapter_29(arg0, arg1) {
    wasm._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hb7151f8ec4a40d6c(arg0, arg1);
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_getWebSocketUrl_e450d186664f9da3 = function(arg0) {
        const ret = getWebSocketUrl();
    ...
    imports.wbg.__wbg_log_33ee0ca6d32a6d35 = function(arg0, arg1) {
    ...
    imports.wbg.__wbg_updateConnectionStatus_616f2934e7e70614 = function(arg0) {
        updateConnectionStatus(arg0 !== 0);
    };
    imports.wbg.__wbg_updateGameStatus_1845f905a09301d5 = function(arg0, arg1) {
        updateGameStatus(getStringFromWasm0(arg0, arg1));
    };
    imports.wbg.__wbg_updatePlayerCount_3cff738c6140fc7a = function(arg0) {
        updatePlayerCount(arg0 >>> 0);
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('wasm_multiplayer_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
